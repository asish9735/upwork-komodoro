      ...
      <div class="box">
		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				$user_tag = '';
				if($v['is_employer'] == '1'){
					$user_tag = '<sup class="badge badge-dark">Employer</sup>';
				}else{
					$user_tag = '<sup class="badge badge-info">Freelancer</sup>';
				}
				...
				<tr>
                  ...
                  <td class="text-right" style="padding-right:15px;">
                      ...
                      <?php if($v['is_employer'] == '1'){}else{?>
                        <a class="dropdown-item" href="<?php echo SITE_URL.'profileview/view/'.$v[$primary_key]; ?>" target="_blank">View Details</a>
                        <?php }?>
