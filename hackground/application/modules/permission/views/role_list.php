              ...
              <table class="table table-hover">
				...
				<tr>
					<td>
						...
						<input type="checkbox" class="check_all magic-checkbox" name="ID[]" value="<?php echo $v['role_id']; ?>" id="item_<?php echo $v['role_id'];?>">
						<label for="item_<?php echo $v['role_id'];?>"></label>
                  ...
                  <td class="text-right" style="padding-right:20px;">
					...
					&nbsp;
					<a href="<?php echo JS_VOID; ?>" onclick="return deleteRecord('<?php echo $v['role_id']; ?>')"data-toggle="tooltip" title="Delete"><i class="icon-feather-trash text-danger <?php echo ICON_SIZE;?>"></i></a>
