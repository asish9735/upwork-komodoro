			  ...
			  <input type="hidden" name="ID" value="<?php echo $ID?>"/>
				...
				<div class="form-group">
                  ...
                  <div class="image-wrapper" id="previous_logo">
					<button type="button" class="close" onclick="removeByID('previous_logo')"><span aria-hidden="true">&times;</span></button>
					<img src="<?php echo UPLOAD_HTTP_PATH.'testimonial-icon/'.$detail['logo']; ?>" class="img-rounded" alt="" width="210">
