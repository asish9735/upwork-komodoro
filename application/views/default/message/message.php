				...
				<div class="messages-container margin-top-0">
					...
					<div class="messages-container-inner" id="message-app">
						...
						<div class="message-content">
							...
							<div class="text-center padding-top-50 padding-bottom-50" v-else>
								<img src="<?php echo IMAGE;?>communication.png" alt="">
								<h5><i class="icon-feather-message-circle"></i> Select a chat to view conversation</h5>
							</div>
						</div>
						<!-- Message Content -->
