...
<div class="row">
	<div class="col">
		...
		<a href="javascript:void(0)" class="btn btn-secondary me-2" id="cancel_account_info"><?php echo __('setting_contact_info_cancel','Cancel');?> </a><button class="btn btn-site accountUpdateBTN"><?php echo __('setting_contact_info_update','Update');?></button>
		</form>
	</div>
</div>