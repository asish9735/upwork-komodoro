...
<form action="" method="post" accept-charset="utf-8" id="locationform" class="form-horizontal" role="form" name="locationform" onsubmit="updateLocation();return false;">  
	<div class="row">
        ...
        <div class="submit-field">
            <label><?php echo __('setting_contact_info_time_zone','Time Zone');?></label>
        ...
        <div class="submit-field remove_arrow_select">
            <label><?php echo __('setting_contact_info_country','Country');?></label>  
        ...
        <div class="submit-field">
            <label><?php echo __('setting_contact_info_address','Address');?></label>
		...
		<div class="row">	
			<div class="col-md-4">
				<div class="submit-field">
					<label><?php echo __('setting_contact_info_city','City');?></label>
			...
			<div class="col-md-4">
				<div class="submit-field">
					<label><?php echo __('setting_contact_info_state','State');?></label>
            ...
            <div class="col-md-4">
				<div class="submit-field">
					<label><?php echo __('setting_contact_info_pastal_code','Postal Code');?></label>
