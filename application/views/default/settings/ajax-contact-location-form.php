...
<div class="row">
	<div class="col">
		...
		<span id="mobile_codeError" class="rerror"></span>			
			...
			<button class="btn btn-site locationUpdateBTN">Update</button>
			<a href="javascript:void(0)" class="popup-with-zoom-anim padding-left-20" id="cancel_location">Cancel </a>
