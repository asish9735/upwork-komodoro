...
<div class="job-listing card-project">
	...
	<div class="job-listing-details">
		...
		<div class="job-listing-description">
        	<div class="d-flex">
			<h4 class="job-listing-title"><a href="<?php echo $v['project_detail_url']; ?>"><?php echo $v['project_title']; ?></a></h4>
            <?php /*?><h3 class="budget ms-auto"><?php echo $budget > 0 ? priceSymbol(). $budget : '';?></h3><?php */?>
            <a href="<?php echo VZ;?>" class="btn btn-circle ms-auto action_favorite <?php echo $is_fav_class;?>" data-pid="<?php echo md5($v['project_id']);?>"><i class="icon-line-awesome-heart"></i></a>
			</div>
           <!-- <p><b><?php echo $budget > 0 ? ($v['is_fixed'] == '1' ? 'Fixed' : 'Hourly') . '' : 'Hourly'; ?></b> <b><?php echo $budget > 0 ? priceSymbol(). $budget : '';?></b> - <span>Intermediate ($$)</span> - <b>Est. Time:</b>  <span>Less than 1 month, 10-30 hrs/week</span></p>		
            ...
            <div class="job-listing-footer">
                <ul>
                	<li><i class="ri-map-pin-line"></i> <?php echo $v['clientdata']->client_location;?></li>
                    <li><i class="ri-heart-line"></i> <?php echo __('job_joblist_proposal','Proposals:');?>  <b><?php echo $v['total_proposal'];?></b></li>                    
                    <li>
                    <?php 
