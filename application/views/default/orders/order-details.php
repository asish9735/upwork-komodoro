...
<div class="order-page">
    ...
    <div id="order-buyer_instruction" class="tab-pane fade">
      ...
      <div id="order-activity" class="tab-pane fade show active">
            ...
            <?php } ?>
            <?php } ?>
            <div class="proposal_reviews mt-5_">
              <?php if($orderDetails->order_status == ORDER_COMPLETED){ 
	if($orderDetails->seller_review || $orderDetails->buyer_review){
		?>
              <div class="card rounded-0 mt-3">
                <div class="card-header bg-fivGrey">
                  <h5 class="text-center mt-2"><i class="fa fa-star"></i> <?php echo (__('order_details_page_Order_Review',"Order Review"));?> </h5>
                </div>
                <div class="card-body">
                  <div class="proposal-reviews">
                    <ul class="reviews-list">
                      <?php if($orderDetails->buyer_review){ ?>
                      <li class="star-rating-row"> <span class="user-picture"> <img src="<?php echo (getMemberLogo($orderDetails->buyer_id)) ?>" width="60" height="60"> </span>
                        <h4> <span class="mr-1">
                          <?php /*echo ($orderDetails->buyer['member']->member_name);*/ echo ($orderDetails->buyer->member_name); ?>
                          </span>
                          <?php
		                for($buyer_i=0; $buyer_i<$orderDetails->buyer_review->buyer_rating; $buyer_i++){
		               	 echo "<img src='".IMAGE."user_rate_full.png'>";
		                }
		                for($buyer_i=$orderDetails->buyer_review->buyer_rating; $buyer_i<5; $buyer_i++){
		                	echo "<img src='".IMAGE."user_rate_blank.png'>";
		                }
		?>
                        </h4>
                        <div class="msg-body"> <?php echo ($orderDetails->buyer_review->buyer_review); ?> </div>
                        <span class="rating-date"><?php echo (dateFormat($orderDetails->buyer_review->review_date,'F d,Y')); ?> </span> </li>
                      <hr class="mb-4">
                      <?php }
            if($orderDetails->seller_review){
            ?>
                      <li class="rating-seller">
                        <h4> <span class="mr-1"><?php echo (__('order_details_page_Freelancers_Feedback',"Freelancer's Feedback"));?></span>
                          <?php 
...
?>
                        ...
                        <span class="user-picture"> <img src="<?php echo (getMemberLogo($orderDetails->seller_id)) ?>" width="40" height="40"> </span>
                        <div class="msg-body"> <?php echo ($orderDetails->seller_review->seller_review); ?> </div>
                        <span class="rating-date"><?php echo (dateFormat($orderDetails->seller_review->review_date,'F d,Y')); ?> </span> </li>
                      <?php
            }
            ?>
                      <hr>
 ...
 ?>
	...
	?>
              <div class="order-review-box mb-3 p-3">
                <h3 class="text-center text-white">
                  <?php if($orderDetails->seller_review){echo (__('order_details_page_Edit_Review_To_Your_Buyer',"Edit Review To Your Buyer"));}else{echo (__('order_details_page_Submit_Review_For_Your_Buyer',"Please Submit a Review For Your Buyer"));}?>
                </h3>
                <div class="row">
                  <div class="col-md-8 offset-md-2">
                    <form method="post"  align="center" id="ratingForm" onsubmit="return performAction(this);return false;">
                      ...
                      <div class="form-group">
                        <label class="h6 text-white"><?php echo (__('order_details_page_Review_Rating',"Review Rating"));?></label>
                      ...
                      <textarea name="review" class="form-control mb-3" rows="5" placeholder="<?php echo (__('order_details_page_Review_Rating_input',"What was your Experience?"));?>"><?php if($orderDetails->seller_review){echo ($orderDetails->seller_review->seller_review);}?>
</textarea>
                      <button type="submit" name="seller_review_submit" class="btn btn-success">
	...
	?>
              <div class="order-review-box mb-3 p-3">
                <h3 class="text-center text-white">
                  <?php if($orderDetails->seller_review){echo (__('order_details_page_Edit_Review_To_Your_Freelancer',"Edit Review To Your Freelancer"));}else{echo (__('order_details_page_Submit_For_Your_Freelancer',"Please Submit a Review For Your Freelancer"));}?>
                </h3>
                <div class="row">
                  <div class="col-md-8 offset-md-2">
                    <form method="post"  align="center" id="ratingForm" onsubmit="return performAction(this);return false;">
                      ...
                      <textarea name="review" class="form-control mb-3" rows="5" placeholder="<?php echo (__('order_details_page_Review_Rating_input',"What was your Experience?"));?>"><?php if($orderDetails->buyer_review){echo ($orderDetails->buyer_review->buyer_review);}?>
</textarea>
                      <button type="submit" name="buyer_review_submit" class="btn btn-success">
