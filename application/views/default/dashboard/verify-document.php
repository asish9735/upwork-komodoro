		...
		<div class="dashboard-content-inner">
			<?php if (!$is_email_verified) { ?>
				<div class="mx-auto alert alert-warning text-center">
					<p class="mb-0"> <i class="icon-material-outline-check-circle text-danger"></i><?php echo __('dashboard_email_verify_first','Your email is not verified. Please verify first to process document verification'); ?> .<a href="<?php D(VZ); ?>" class="btn btn-site btn-sm resendEmail"><?php echo __('dashboard_freelancer_resend_email','Resend Email'); ?></a></p>
				</div>
			<?php } elseif ($is_doc_verified) { ?>
				...
				<?php if ($show_form) { ?>
					...
					<h1 class=" mb-4"><?php echo __('dashboard_document_application_verification','Application for document verification'); ?></h1>
					<form action="" method="post" accept-charset="utf-8" id="documentform" class="form-horizontal" role="form" name="documentform" onsubmit="saveDocument(this);return false;">
						<div class="panel mb-4">
							<div class="panel-header">
								<h4><i class="icon-material-outline-account-circle text-site"></i><?php echo __('dashboard_document_id_proff','ID Proff'); ?>  </h4>
							</div>
							<div class="panel-body">
								<div class="submit-field">
									<h5><?php echo __('dashboard_document_document_name','Document Name'); ?></h5>
								...
								<div class="submit-field mb-0">
									<h5><?php echo __('dashboard_document_attachment','Attachment'); ?></h5>
									<input type="file" id="upload1" class="d-none" accept="image/*, application/pdf">
									<div class="upload-area" id="uploadfile1">
										<h4><?php echo __('dashboard_document_drag','Drag'); ?> &nbsp;<?php echo __('dashboard_document_drop_file','drop file here or'); ?>  <span class="text-site"><?php echo __('dashboard_document_click','click'); ?></span><?php echo __('dashboard_document_to_select_file','to select file'); ?> </h4>
									</div>
									<p><small><?php echo __('dashboard_document_only_image_pdf','Note: Only image and pdf allowed'); ?></small></p>
						...
						<div class="panel mb-4">
							<div class="panel-header">
								<h4><i class="icon-feather-map-pin text-site"></i><?php echo __('dashboard_document_address_proff','Address Proff'); ?>  </h4>
							</div>
							<div class="panel-body">
								<div class="submit-field">
									<h5><?php echo __('dashboard_document_document_name','Document Name'); ?></h5>
						...
						<button class="btn btn-site saveBTN"><?php echo __('dashboard_document_submit','Submit'); ?></button>&nbsp;
