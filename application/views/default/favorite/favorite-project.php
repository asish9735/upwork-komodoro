              ...
              <div class="job-listing">
                <div class="job-listing-details">
                  <div class="job-listing-description">
                    <h5 class="job-listing-title"> <a href="<?php echo $favorite_url;?>" target="_blank"><?php echo ucfirst($favorite->project_title);?></a> <span class="text-muted small"> -
                      <?php D($favorite->experience_level_name);?>
                      (<i class="icon-feather-<?php D($favorite->experience_level_key);?>"></i>)</span></h5>
                    <p class="mb-2"><?php echo $favorite->project_short_info;?></p>
                    <div class="job-listing-footer">
                      <ul>
                        <?php if($favorite->is_fixed==1){
					?>
                        <li><b><?php echo __('favorite_freelancer_F_price','Fixed Price:');?></b>
                          <?php if($budget){echo $currency.priceFormat($budget);}?>
                        </li>
                        <?php }?>
                        <li><b><?php echo __('favorite_freelancer_industry','Industry:');?></b>
                          <?php D($favorite->category_name);?>
                        </li>
                        <li><i class="icon-feather-clock text-site"></i>
                          <?php D(get_time_ago($favorite->project_posted_date));?>
                        </li>
                      </ul>
                    </div>
                  </div>
