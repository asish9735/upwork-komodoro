  ...
  <div class="dashboard-content-container" >
    <div class="dashboard-content-inner"> 
      ...
      <div class="dashboard-box">
        <div class="headline">
          <h4>
            <?php if($bookmark_type=='freelancer'){?>
            <?php echo __('favorite_freelancer','My favorite freelancer');?>
            <?php }else{?>
            <?php echo __('favorite_freelancer_project','My favorite projects');?>
            <?php }?>
          </h4>
        </div>
        <div class="content">
...
if($list){
	foreach($list as $l=>$favorite){
		$favorite_url=get_link('viewprofileURL').'/'.$favorite->member_id;
...
?>
            <li>
              <div class="job-listing width-adjustment">
                <div class="job-listing-company-logo"> <img src="<?php echo $logo;?>" alt=""> </div>
                <div class="job-listing-details">
                  <div class="job-listing-description">
                    <h5 class="job-listing-title"> <a href="<?php echo $favorite_url;?>" target="_blank"><?php echo $favorite->member_name;?></a>
                      <?php if($badges){
			  ...
			  ?>
                    ...
                    <div class="job-listing-footer">
                      <ul>
                        ...
                        <li><b><?php echo __('favorite_freelancer_earning','Earnings:');?></b>
                          <?php D($currency.displayamount($favorite->total_earning,2));?>
                        </li>
              ...
              <!-- Buttons -->
              <div class="buttons-to-right single-right-button always-visible"> <a href="<?php echo $favorite_url;?>" target="_blank" class="btn-edit btn-circle" data-tippy-placement="top" data-tippy="" title="View"> <i class="icon-feather-eye"></i> </a> <a href="<?php echo VZ;?>" data-id="<?php echo md5($favorite->member_id);?>" data-action="remove" class="btn-delete btn-circle mark_fav" data-tippy-placement="top" data-tippy="" title="Remove"> <i class="icon-feather-trash-2"></i> </a> </div>
            </li>
            <?php
	}
}else{
?>
            <li>
              <p><?php echo __('favorite_freelancer_no_record','No record');?></p>
            </li>
            <?php
}
?>
