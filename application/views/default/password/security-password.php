			...
			<!-- Row -->
				...
				<!-- Dashboard Box -->
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-material-outline-account-circle"></i> Password <a href="<?php echo VZ;?>" class=" gray ico float-right edit_password" data-tippy-placement="top"  title="Edit"><i class="icon-feather-edit"></i></a></h3>
							
						</div>

						<div class="content with-padding padding-bottom-15" id="passwordLoad">
							<p><i class="icon-material-outline-check-circle text-success"></i> Password has been set</p>
							<p>Choose a strong, unique password that’s at least 6 characters long.</p>
						</div>
	...
	<div class="sign-in-form">
		...
		<div class="popup-tabs-container">
			...
			<div class="popup-tab-content" id="tab">
				...
				<!-- Welcome Text -->
				<div class="">
				<a href="" class="btn padding-left-0">+ New Client Account</a>
