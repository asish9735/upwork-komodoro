    ...
    <div class="content with-padding">
      ...
      <div class="submit-field myradio">
        ...
        <div class="btn-group">          
            ...
            <label for="defaultInlineHourly" class="btn <?php if($projectData && $projectData['project_settings']->is_hourly==1){echo "active";}?>"><i class="icon-feather-clock"></i><br><?php echo __('postproject_hourly','Hourly');?> </label>
            ...
            <label for="defaultInlineFixed" class="btn <?php if($projectData && $projectData['project_settings']->is_fixed==1){echo "active";}?>"><i class="icon-feather-tag"></i><br><?php echo __('postproject_fixed','Fixed');?> </label>
        </div>
      ...
      <div class="submit-field myradio">
        ...
        <div class="btn-group">
          <?php if($all_projectExperienceLevel){
            ...
            <label for="defaultInline<?php D($keydata->experience_level_key);?>" class="btn <?php if($projectData && $projectData['project_settings']->experience_level_key==$keydata->experience_level_key){echo 'active';}?>"><i class="icon-feather-<?php D($keydata->experience_level_key);?>"></i><br>
        ...
        <div class="submit-field myradio">
          ...
          <div class="btn-group">
			...
			?>            
              ...
              <label for="defaultInline<?php D($key);?>" class="btn <?php if($projectData && $projectData['project_settings']->hourly_duration==$key){echo "active";}?>"><i class="icon-line-awesome-<?php D($key);?>"></i><br><?php D($keydata['name']);?>
            </label>
            <?php
				}
			}
        ...
        <div class="submit-field myradio">
          ...
          <div class="btn-group">
			...
			?>            
              ...
              <label for="defaultInlineDuration<?php D($key);?>" class="btn <?php if($projectData && $projectData['project_settings']->hourly_time_required==$key){echo "active";}?>"><i class="icon-feather-<?php D($key);?>"></i><br>
              <?php D($keydata['name']);?>
            </label>
            <?php
				}
