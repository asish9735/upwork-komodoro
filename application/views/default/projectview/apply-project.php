...
<div class="container">
  ...
  <form action="" method="post" accept-charset="utf-8" id="applyprojectform" class="form-horizontal" role="form" name="applyprojectform" onsubmit="return false;">
    ...
    <div class="panel">
      ...
      <div class="panel-body">
        <?php
			if($project_question){
			?>
        <label><?php echo __('projectview_apply_question','Question');?></label>
        <?php
    ...
    <div class="padding-bottom-15 padding-top-15">
      <button class="btn btn-site nextbtnapply"><?php echo __('projectview_apply_submit_proposal','Submit Proposal');?></button>
      &nbsp;
