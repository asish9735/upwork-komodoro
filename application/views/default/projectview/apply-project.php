      ...
      <div class="panel-body">
        <div class="form-group">
          ...
          <div class="radio">
            ...
            <label for="payment_at_milestone"><span class="radio-label"></span> <b>By milestone</b><br>
              <span>Divide the project into smaller segments, called milestones. You'll be paid for milestones as they are completed and approved.</span></label>
          </div>
          <br>
          <div class="radio">
            ...
            <label for="payment_at_project"><span class="radio-label"></span> <b>By project</b><br>
              <span>Get your entire payment at the end, when all work has been delivered.<small></small></span></label>
          </div>
        </div>
        ...
        <div class="payment_project_wrapper" <?php if($getBidDetails && $getBidDetails->bid_by_project==1){}else{?> style="display: none"<?php }?>>
          ...
          <div class="padding-top-20" style="max-width:720px">
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="input-with-icon-left"> <i><?php echo $currency;?></i>
        ...
        <div class="form-group">
          ...
          <div id="uploadfile_container">
            ...
            <div id="thumbnail_<?php D($inc)?>" class="thumbnail_sec">
              ...
              <a href="javascript:void(0)" class=" text-danger ico float-right" onclick="$(this).parent().remove()"><i class="icon-feather-trash"></i></a></div>
            <?php
                    }
