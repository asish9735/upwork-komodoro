...
<div class="container">            
    ...
    <aside class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-12">			
        ...
        <div class="card-body">
            ...
            <h1 class="h4 mb-4 text-success"><?php echo __('user_page_verify_account','Your account has been activated successfully.');?></h1>
...
<div class="container">            
    ...
    <aside class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-12">			
        ...
        <div class="card-body">
            ...
            <h1 class="h4 mb-4 text-danger"><?php echo __('user_page_verify_account_invalid','Your account activation link is invalid.');?></h1>
            <a href="<?php D(get_link('homeURL'))?>" class="btn btn-site mb-2"><?php echo __('user_page_success_back_home','Back to Home');?></a>
		</div>
        </div>
	</aside>        
