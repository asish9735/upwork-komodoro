	...
	<div class="row">
		...
		<div class="col-xl-9 col-lg-8 col-12">
            ...
            <div class="search-box input-group margin-top-15">
                ...
                <div class="input-group-append"><button type="button" class="btn btn-site"><?php echo __('home_page_findjob_search','Search');?></button></div>
			</div>
				...
				<div class="task-listing">
					...
					<div class="task-listing-bid">
						<div class="task-listing-bid-inner">
							...
							<span class="btn btn-site"><?php echo __('home_page_findjob_bid_now','Bid Now');?> </span>
						</div>
					</div>
                    </div>
				...
				<div class="task-listing">
					...
					<div class="task-listing-bid">
						<div class="task-listing-bid-inner">
							...
							<a href="#" class="btn btn-site"><?php echo __('home_page_findjob_bid_now','Bid Now');?> </a>
						</div>
					</div>
                    </div>
                    <div class="task-listing-footer">
