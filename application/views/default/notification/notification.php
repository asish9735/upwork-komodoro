  ...
  <div class="dashboard-content-container">
    <div class="dashboard-content-inner" > 
      ...
      <div class="dashboard-box margin-top-0"> 
        ...
        <!-- Headline -->
        <div class="headline">
          <h4><?php echo __('notification_all','All Notifications');?></h4>
        </div>
        <div class="content">
            ...
            <li>
              <div class="job-listing"> 
                ...
                <div class="job-listing-details"> 
                  ...
                  <!-- Details -->
                  <div class="job-listing-description"> <span class="float-end text-muted d-none d-md-block"><i class="icon-material-outline-access-time"></i> <?php echo $list->time_ago;?></span>
