...
<div id="dataStep-2" style="display: none">
  <div class="dashboard-box margin-top-0"> 
    <!-- Headline -->
    <div class="headline">
      <h3><?php echo __('postproposal_budget','Budget');?>  </h3>
    </div>
    <div class="content with-padding">
      <div class="submit-field myradio">
        <label><?php echo __('postproposal_how_pay','How would you like to sell service ?');?></label>
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
          <label class="btn <?php if($proposalData && $proposalData['proposal_settings']->is_package==1){echo "active";}?>">
            <input type="radio" class="proposal_payment_type" id="defaultInlineHourly" name="proposalPaymentType" value="package" autocomplete="off" <?php if($proposalData && $proposalData['proposal_settings']->is_package==1){echo "checked";}?>>
            <i class="icon-feather-package"></i><br>
            <?php echo __('postproposal_package','Package');?> </label>
          <label class="btn <?php if($proposalData && $proposalData['proposal_settings']->is_package!=1){echo "active";}?>">
            <input type="radio" class="proposal_payment_type" id="defaultInlineFixed" name="proposalPaymentType" value="fixed" autocomplete="off" <?php if($proposalData && $proposalData['proposal_settings']->is_package!=1){echo "checked";}?>>
            <i class="icon-feather-tag"></i><br>
            <?php echo __('postproposal_fixed','Fixed');?> </label>
        </div>
...
?>
    <div class="row">
      <div class="basic_package col-md-4 col-12" <?php if($proposalData){}else{?>style="display: none" <?php }?>>
        <div class="section-package">
          <div class="headline padding-left-0">
            <h3>Basic</h3>
          </div>
    ...
    <div class="dashboard-box-footer">
      <button class="btn btn-secondary backbtnproposal" data-step="2"><?php echo __('postproposal_back','Back');?></button>
