...
<div id="dataStep-6" style="display: none">
  <div class="dashboard-box"> 
    ...
    <div class="content with-padding">
        <div class="submit-field">
          ...
          <label class="form-label"><?php echo __('postproposal_proposal_skills','Tags');?></label>
  ...
  <div class="dashboard-box" hidden> 
    ...
    <div class="content with-padding">
      <div class="submit-field mb-0">        
        <label class="form-label"><?php echo __('postproposal_description','Description');?></label>
        ...
        <label class="form-label"><?php echo __('postproposal_attachment','Attachment');?></label>
  ...
  <div class="dashboard-box" hidden> 
    ...
    <div class="content with-padding">
      <div class="submit-field">        
        <label class="form-label"><?php echo __('postproposal_proposal_type','Type of proposal');?></label>
      ...
      <div class="submit-field">
        <label class="form-label"><?php echo __('postproposal_screen_question','Screen question (optional)');?></label>
        <div id="preview_question_sec" style="display: none"></div>
      </div>
      <div class="submit-field mb-0">  
        <label class="form-label"><?php echo __('postproposal_cover_letter','Required cover letter');?></label>
  ...
  <div class="dashboard-box" hidden> 
    ...
    <div class="content with-padding padding-bottom-0">      
      <div class="row">
        <div class="col-xl-6">
            <div class="submit-field">        
                <label class="form-label"><?php echo __('postproposal_proposal_visibility','Project visibility');?></label>
                <p id="preview_proposalVisibility"></p>
            </div>
        </div>
        <div class="col-xl-6">
            <div class="submit-field"> 
                <label class="form-label"><?php echo __('postproposal_freelancer_need','Freelancer need');?></label>
  ...
  <div class="dashboard-box" hidden> 
    ...
    <div class="content with-padding padding-bottom-0">      
      <div class="row">
        <div class="col-xl-6">
          <div class="submit-field">
            <label class="form-label"><?php echo __('postproposal_h_fixed_price','Hourly or Fixed price');?></label>
            <p id="preview_proposalPaymentType"></p>
          </div>
        </div>
        <div class="col-xl-6">
          <div class="submit-field">
            <label class="form-label"><?php echo __('postproposal_experience_level','Experience level');?></label>
      ...
      <div class="row hourly_proposal_display" style="display: none">
        <div class="col-xl-6">
          <div class="submit-field">
            <label class="form-label"><?php echo __('postproposal_proposal_duration','Project Duration');?></label>
            <p id="preview_hourly_duration"></p>
          </div>
        </div>
        <div class="col-xl-6">
          <div class="submit-field">
            <label class="form-label"><?php echo __('postproposal_proposal_time','Project Time');?></label>
