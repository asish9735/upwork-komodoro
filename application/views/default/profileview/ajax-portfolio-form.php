				...
				<input  type="hidden" value="<?php echo $dataid;?>" id="dataid" name="dataid"/>
       				...
       				<div class="row">
						<div class="col-xl-12">
							<div class="submit-field">
								<h5>Project Title</h5>
								<input type="text" class="form-control input-text with-border" value="<?php if($memberInfo){D($memberInfo->portfolio_title);}?>" name="title" id="title">
						...
						<div class="col-xl-12">
							<div class="submit-field">
								...
								<input type="text" class="form-control input-text with-border" value="<?php if($memberInfo){D($memberInfo->portfolio_url);}?>" name="url" id="url">
						...
						<div class="col-xl-12">
							<div class="submit-field">
								...
								<textarea  class="form-control input-text with-border" name="description" id="description"><?php if($memberInfo){D($memberInfo->portfolio_description);}?></textarea>
       			...
       			<div class="col-xl-6">
       				<div class="row">
						...
						<div class="col-xl-12 sub_category_display" <?php if($memberInfo && $category_list->category_id){}else{D('style="display: none"');}?> >
							<div class="submit-field remove_arrow_select">
								<h5>Sub Category</h5>
						...
						<div class="col-xl-12">
							<div class="submit-field">
								...
								<input type="date" class="form-control input-text with-border" value="<?php if($memberInfo && $memberInfo->portfolio_complete_date){D(date('Y-m-d',strtotime($memberInfo->portfolio_complete_date)));}?>" name="complete_date" id="complete_date" min="1990-12-31" max="<?php echo D(date('Y-m-d',strtotime('+5 year')));?>" placeholder="DD-MM-YYYY">
