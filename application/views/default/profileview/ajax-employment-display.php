...
<?php if($is_editable){?>
	<div class="float-end">
		<a href="javascript:void(0)" class="edit_account_btn btn-edit btn-circle" data-popup="employment" data-popup-id="<?php D($employment->employment_id)?>" data-tippy-placement="top" title="Edit"><i class="icon-feather-edit-3"></i></a> 
		<a href="javascript:void(0)" class="delete_account_btn btn-delete btn-circle ms-1" data-popup="employment" data-popup-id="<?php D($employment->employment_id)?>" data-tippy-placement="top" title="Delete"><i class="icon-feather-trash"></i></a>
	</div>
<?php }?>
