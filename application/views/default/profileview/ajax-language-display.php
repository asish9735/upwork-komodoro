...
<?php if($is_editable){?>
	<div class="float-right">
		<a href="javascript:void(0)" class="edit_account_btn btn btn-outline-secondary btn-circle" data-popup="language" data-popup-id="<?php D($language->member_language_id)?>" data-tippy-placement="top" title="Edit language"><i class="icon-feather-edit-3"></i></a> 
