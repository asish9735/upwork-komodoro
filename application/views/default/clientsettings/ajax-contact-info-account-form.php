		...
		<div class="row">
			<div class="col-md-4">
				<div class="submit-field">
					<label class="form-label"><?php echo __('contact_company_account_name','Name');?></label>
			...
			<div class="col-md-4">
            <a href="javascript:void(0)" class="btn btn-secondary me-2" id="cancel_account_info"><?php echo __('contact_company_form_cancel','Cancel');?> </a>
			<button class="btn btn-site accountUpdateBTN"><?php echo __('contact_company_form_update','Update');?></button>
