			...
			if($member_id){
				...
				if(($owner_organization_id && $owner_organization_id==$organization_id) || ($bidder_id=$member_id)){
					...
					$memberDataBasic=getData(array(
						'select'=>'m.member_name,m_b.member_heading,m_b.member_overview,m_b.member_hourly_rate,c_n.country_name,c.country_code_short,m_l.logo,m_b.available_per_week,m_b.not_available_until,m_s.avg_rating,m_s.total_earning,m_s.no_of_reviews,m_s.total_working_hour',
						'table'=>'member as m',
