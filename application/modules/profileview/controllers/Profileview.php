...
class Profileview extends MX_Controller {
	...
	public function index()
	{
		...
		if($this->loggedUser){
			...
			redirect(get_link('viewprofileURL')."/".$log_member_id);
		}else{
